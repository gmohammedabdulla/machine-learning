...
def create_model(X_train, Y_train, n,epochs = 10000, learning_rate = 0.001):
    '''
    ...
    for i in range(epochs):
        #get the gradients 
        dW = get_gradient(X_train, Y_train, W, n)
...
def main():
    ...
    n = float(len(x_train))
    w1,w2, W = create_model(X_train, Y_train,n)
